        ...
        <header className="text-[#FFFFFF] body-font bg-[#398E8A]">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <Link href={'/'} className="flex title-font font-medium items-center  mb-4 md:mb-0">
                    <span className="ml-3 text-2xl">M KASHAN MALIK AWAN</span>
                </Link>
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <Link href={'/contact'} className="mr-5 hover:text-[#398E8A] hover:bg-[#FFFFFF] p-2 rounded-3xl hover:px-6 hover:text-lg">Contact Us</Link>
                </nav>
